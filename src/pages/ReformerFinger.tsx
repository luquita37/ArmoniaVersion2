...
export default function ReformerFinger() {
  const whatsappNumber = '5493492271506';
  const whatsappMessage = encodeURIComponent('Hola! Quiero mi Reformer Armonía Finger. ¿Podrían darme más información?');
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=${whatsappMessage}`;

  const specs = [
    { label: 'Estructura', value: 'Madera finger seleccionada y laqueada' },
    { label: 'Dimensiones', value: '2.61m de largo, 71cm de ancho, 40cm de piso al respaldo del carro' },
    { label: 'Tablas', value: '40mm de espesor con laterales de 18cm de ancho y bordes redondeados' },
    { label: 'Tapizado', value: 'Cuerina calidad automotor, semi rígida' },
    { label: 'Respaldo', value: 'Goma plástica de alta densidad' },
    { label: 'Hombreras', value: 'Goma plástica de alta densidad, desmontables' },
    { label: 'Rieles', value: 'Aluminio sobre tacos de madera' },
    { label: 'Carro', value: '8 ruedas cónicas, estructura metálica reforzada' },
    { label: 'Resortes', value: '1 juego (2 rojos, 1 amarillo, 1 azul, 1 verde)' },
    { label: 'Soga', value: 'Náutica de 8mm dacron, color negro' },
    { label: 'Motones', value: 'Motones náuticos de calidad profesional' },
    { label: 'Mordazas', value: 'Mordazas media nuez náuticas' },
    { label: 'Agarres', value: '1 par de mano y 1 par de pie' },
    { label: 'Cinta de seguridad', value: 'Cinta para abdominales incluida' },
    { label: 'Regulación resortes', value: '3 posiciones de ajuste' },
    { label: 'Barra de pie', value: '3 posiciones de regulación, estructura pintada, cubierta con goma plástica y funda' },
    { label: 'Box', value: 'Madera con tapizado, acolchonado en la parte superior, 2 manijas laterales' },
    { label: 'Tabla de pique', value: 'Laqueada con goma eva punta diamante' }
  ];
    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full mb-8 shadow-lg" style={{ backgroundColor: '#d4a574' }}>
            ...
            <span className="text-lg font-medium" style={{ color: '#3a2f25' }}>
              PLAZO DE ENTREGA: 50 DÍAS APROXIMADAMENTE
            </span>
          </div>
          ...
          <p className="text-2xl md:text-3xl mb-6 font-light" style={{ color: '#7d6b5a' }}>
            El equipo profesional que transforma tu estudio
          </p>
          <p className="text-lg md:text-xl text-gray-600 font-light mb-12 max-w-3xl mx-auto leading-relaxed">
            Fabricado con materiales de alta calidad y respaldado por más de 20 años de experiencia. Seguridad, durabilidad y precisión en cada movimiento.
          </p>
          <a
            href={whatsappLink}
            target="_blank"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <img
              src="/img_0210_(1).jpg"
              alt="Reformer Finger Armonía"
              className="w-full rounded-2xl shadow-lg"
            />
            <div>
              <h2 className="text-3xl md:text-4xl font-light mb-6" style={{ color: '#7b4b23' }}>
                CALIDAD PROFESIONAL PARA TU ESTUDIO
              </h2>
              <p className="text-lg text-gray-600 font-light leading-relaxed">
                Nuestro Reformer Finger es un producto diseñado para estudios de pilates, kinesiólogos y fisioterapeutas, que buscan una herramienta de calidad profesional con el enfoque en brindar una excelente experiencia para el usuario tanto en confort como en insonoridad y una relación de precio incomparable con sus características de desempeño, resistencia y materiales empleados.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20" style={{ backgroundColor: '#f5f1ec' }}>
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="flex justify-center">
            <div className="rounded-2xl overflow-hidden shadow-lg bg-white max-w-md">
              <video
                controls
                className="w-full"
                playsInline
                preload="metadata"
                poster="/reformer_finger_video-cover.jpg"
              >
                <source src="/reformer-finger.mp4" type="video/mp4" />
                Tu navegador no soporta el video.
              </video>
              <div className="p-6" style={{ backgroundColor: '#f5f1ec' }}>
                <h3 className="text-xl font-light mb-2" style={{ color: '#6b5344' }}>Reformer Finger</h3>
                <p className="text-gray-600 font-light">Estructura fabricada en madera maciza y detalles de construcción profesional</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-light mb-4" style={{ color: '#6b5344' }}>
              BENEFICIOS DEL REFORMER ARMONÍA
            </h2>
            <p className="text-lg text-gray-600 font-light">
              Todo lo que necesitas en un solo equipo profesional
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: Wind, title: 'Fluidez en el movimiento', desc: 'Deslizamiento con ruedas cónicas inyectadas con rulemanes blindados' },
              { icon: Sparkles, title: 'Estética premium', desc: 'Diseño elegante que realza tu estudio' }
            ].map((benefit, index) => (
      ...
      <section className="py-20" style={{ backgroundColor: '#f5f1ec' }}>
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 font-light">
              Diseño pensado para profesionales exigentes
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto mb-12">
            <div className="p-8 rounded-2xl text-center shadow-2xl" style={{ backgroundColor: '#d4a574' }}>
              ...
              <p className="text-lg font-light" style={{ color: '#3a2f25' }}>
                Principio de Febrero. Reservá tu lugar en la próxima producción.
              </p>
            </div>
          </div>
